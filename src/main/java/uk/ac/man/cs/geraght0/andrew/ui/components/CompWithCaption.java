...
@Getter
public class CompWithCaption<T extends Node> extends VBox implements WrapperComp {

  private final Label lblInfo;
  private final T component;

  public CompWithCaption(String caption, T component) {
    this.lblInfo = new Label(caption);
    lblInfo.setLabelFor(component);
    this.component = component;
    this.getChildren().addAll(lblInfo, component);
  }
